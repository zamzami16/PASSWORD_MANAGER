...
class managementWindow:
    def __init__(self, container):
        ...
        self.generate_pass = ttk.Frame(self.tabControl)
        self.change_pass = ttk.Frame(self.tabControl)
        self.tabControl.add(self.tab_register, text="Register")
        self.tabControl.add(self.generate_pass, text="Generate Password")
        ...
        # add element in tab generate password
        ttk.Label(self.generate_pass, text="Still under development").pack(
            expand=1
        )
